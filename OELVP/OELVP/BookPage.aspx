<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookPage.aspx.cs" Inherits="OELVP.BookPage" %>
...
<head runat="server">
    ...
    <title>Book Store Book Page</title>
</head>
<body>
    ...
    <div style="background-color: white; margin-left: 500px; margin-top: 30px; padding: 50px; height: 750px; width: 600px;">
        ...
        <div class="form-row"> 
            ...
            <div class="col-sm-12 text-center  p-2"> 
                <asp:GridView ID="GridView1" runat="server" Width="499px"></asp:GridView>
            </div>
            <div class="col-sm-12 text-center  p-2"> 
